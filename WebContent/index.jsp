...
if(session.getAttribute("Shop") == null) {
	...
	cafeNero.inventory.coffee += Double.parseDouble(request.getParameter("coffeeOrder"));
	cafeNero.inventory.cups += Integer.parseInt(request.getParameter("cupOrder"));
	cafeNero.inventory.milk += Double.parseDouble(request.getParameter("milkOrder"));
	cafeNero.inventory.sugar += Double.parseDouble(request.getParameter("sugarOrder"));
	
	cafeNero.balance -= cafeNero.priceTable.cupPrice * Integer.parseInt(request.getParameter("cupOrder"));
	cafeNero.balance -= cafeNero.priceTable.coffeePrice * Double.parseDouble(request.getParameter("coffeeOrder"));
...
<table width="80%" border="1">
  ...
  <tr>
    <td colspan="6"><p>Day <jsp:text>${day}</jsp:text></td>
  </tr>
  <tr>
    <td>Daily Sales</td>
